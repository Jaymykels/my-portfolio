...
export default new Vuex.Store({
  state: {
    ...
    resume: 'https://www.dropbox.com/s/bfqn530eiu49tqn/Michael%20Ezeokoye.pdf?dl=0',
    contract: ['Foodlocker', 'Vinsight', 'Stears'],
    skills: ['Requirement Analysis', 'System Architecture', 'Project Management', 'Programming', 'DevOps', 'Quality Assurance'],
    professional_experience: [
      {
        period: 'DEC 2018 - PRESENT',
        company: 'INTERSWITCH',
        position: 'Software Engineer',
        responsibilities: 'Worked on design, implementaion and application development, creating user interfaces that reflect the business requirement and satifies the system requirement specification.'   
      },
      {
        period: 'FEBRUARY 2018 - SEPTEMBER 2018',
        company: 'CREDIT CLAN',
        position: 'Software Engineer',
        responsibilities: 'Seeing out a project from conception to final product, by developing and designing web applications and ensuring their responsiveness and ability to scale.'   
      },
      {
    ...
    education: [
      {
        ...
        summary: 'Graduated from the department of Computer Science University of Ibadan.'
      },
      {
      ...
      },
      {
        ...
        summary: 'Completed the West African Senior Secondary School O Level Certificate examination.'
      }
    ],
    technical_skills: [
      {
    ...
    projects: [
      {
        ...
        description: 'A platform that gives insight into the Nigeria Elections conducted by the Independent National Electoral Commission of Nigeria.',
        link: 'https://nigeriaelections.stearsng.com'
      },
      {
        title: 'FOODLOCKER',
        image: '@/assets/images/projects/foodlocker.png',
        description: 'AN E-commerce web application with an Inventory management system an POS for a Food Mart.',
      ...
      },
      {
        ...
        description: 'A decission support system for student academics performace analytics that processes academic result and predicts academic performance.',
        link: 'https://dsssapa.herokuapp.com'
      },
      {
        title: 'FOLIO MEDIA GROUP (PROTOTYPE)',
        image: '@/assets/images/projects/folio.png',
        description: 'A platform that keeps you updates with the latest news around with video content and advertisement.',
